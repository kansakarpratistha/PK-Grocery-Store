  ...
  return (
    <div class="w3l_banner_nav_right">
      ...
      <div class="w3l_banner_nav_right_banner3_btm">
        <Row>
          <Col md={4} class="w3l_banner_nav_right_banner3_btml">
            <div class="view view-tenth">
              <Image fluid src={image24} alt=" " class="img-responsive" />
              <div class="mask">
                <h4>Grocery Store</h4>
                <p>
          ...
          <Col md={4} class="w3l_banner_nav_right_banner3_btml">
            <div class="view view-tenth">
              <Image fluid src={image29} alt=" " class="img-responsive" />
              <div class="mask">
                <h4>Grocery Store</h4>
                <p>
                  Excepteur sint occaecat cupidatat non proident, sunt in culpa
          ...
          <Col md={4} class="w3l_banner_nav_right_banner3_btml">
            <div class="view view-tenth">
              <Image fluid src={image30} alt=" " class="img-responsive" />
              <div class="mask">
                <h4>Grocery Store</h4>
                <p>
                  Excepteur sint occaecat cupidatat non proident, sunt in culpa
      ...
      <div class="w3ls_w3l_banner_nav_right_grid w3ls_w3l_banner_nav_right_grid_veg">
        ...
        <div class="w3ls_w3l_banner_nav_right_grid1 w3ls_w3l_banner_nav_right_grid1_veg">
          <Row>
            <Col
              md={3}
              class="w3ls_w3l_banner_left w3ls_w3l_banner_left_asdfdfd"
            >
            ...
            <Col md={3} class="w3ls_w3l_banner_left">
              <div class="hover14 column">
                <div class="agile_top_brand_left_grid w3l_agile_top_brand_left_grid">
            ...
            <Col md={3} class="w3ls_w3l_banner_left w3ls_w3l_banner_left_asd">
              <div class="hover14 column">
                <div class="agile_top_brand_left_grid w3l_agile_top_brand_left_grid">
                  <div class="agile_top_brand_left_grid_pos">
                    <Image fluid
...
export default FrozenBannerRight;
